...
namespace UnitTests
{
    ...
    public class AprioriTest
    {
        ...
        public AprioriTest()
        {
            _minSupport = 0.2;
            _minConfidence = 0.6;
            _items = new string[10] { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j" };
            _transactions = new string[15] { "acdfj", "bcefi", "abcej", "bdegh", "abfgi", "bcegj", "acehi", "bcdeh", "aefgh", "abcde", "bcdef", "cdefg", "defgh", "efghi", "fghij" };
